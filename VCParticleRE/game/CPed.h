...
public:
    ...
    unsigned char m_bAddRotOffset;
private:
    char _pad15[3];
};


VALIDATE_OFFSET(CWeapon, m_Type, 0x0);
VALIDATE_OFFSET(CWeapon, m_nState, 0x4);
VALIDATE_OFFSET(CWeapon, m_nAmmoInClip, 0x8);
VALIDATE_OFFSET(CWeapon, m_nTotalAmmo, 0xC);
...
public:
	...
	Bool IsPlayer()
	{
		return ((Bool (__thiscall *)(CPed *))AddressByVersion(0x4F4930, 0x4F4950, 0x4F47F0))(this);
	}
};
