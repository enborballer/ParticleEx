...
{
	return ((bool (__cdecl *)(CVector const&, float, CColPoint&, CEntity*&, bool, bool, bool, bool, bool, bool, CStoredCollPoly*))AddressByVersion(0x4D8B00, 0x4D8B20, 0x4D89C0))(pos, a2, point, entity, a5, a6, a7, a8, a9, a10, a11);
}
...
{
	return ((float (__cdecl *)(float, float, float, bool*))AddressByVersion(0x4D53A0, 0x4D53C0, 0x4D5260))(x, y, z, bOut);
}
