...
unsigned char& CTimer::m_CodePause = *(unsigned char *)AddressByVersion(0x95CDB1, 0x95CF69, 0x96D0A9);
unsigned char& CTimer::m_UserPause = *(unsigned char *)AddressByVersion(0x95CD7C, 0x95CF34, 0x96D074);
