...
RwTexture *&gpBloodPoolTex = *(RwTexture **)AddressByVersion(0x9415F8, 0x9417B0, 0x9518F0);
...
{
	((void (__cdecl *)(CVector const &, float, float))AddressByVersion(0x50F760, 0x50F950, 0x50F8E0))(vecPos, fPower, fSize);	
}