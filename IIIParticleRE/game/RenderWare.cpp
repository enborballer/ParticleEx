...
RwBool RwTextureDestroy(RwTexture* texture)
{
	...
	return ((RwBool (__cdecl *)(RwTexture*))AddressByVersion(0x5A7330, 0x5A75F0, 0x5A8B30))(texture);
}

RwTexture* RwTextureRead(RwChar const* name, RwChar const* maskName)
{
	return ((RwTexture* (__cdecl *)(RwChar const*, RwChar const*))AddressByVersion(0x5A7580, 0x5A7840, 0x5A8E00))(name, maskName);
}