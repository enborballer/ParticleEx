...
#else
	Char Path[MAX_PATH];
	sprintf(Path,"%s\\ParticleEx\\XBOX\\PARTICLE.CFG", GetAsiPath().c_str());
	Int32 result = CFileMgr::LoadFile(Path, work_buff, ARRAY_SIZE(work_buff), "r");
